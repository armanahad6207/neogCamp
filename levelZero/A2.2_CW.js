...
console.log("Is Rohit is Older Than rahul?", isRohitOlder)

console.log("---- ---- ----")

console.log("1.2")
let isRohitYounger = rohitAge < rahulAge
console.log("Is Rohit is Younger than Rahul?", isRohitYounger)
...
console.log("Are Rohiy and Roma of the same age?", isRohitEqualRoma)
...
console.log("Is Nina Older or Equal to Rahul?", isNinaOlderOrSameRahul)

console.log("---- ---- ----")

console.log("1.5")
let isNinaOlderOrSameRohit = ninaAge >= rohitAge
console.log("Is Nina Older or Equal to Rohit?", isNinaOlderOrSameRohit)
