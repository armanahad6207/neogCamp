...
console.log("Is Akashy faster than Ravi in the 100m sprint?", isAkshayFaster);
...
console.log("Is Akashy faster than Ravi in the 400m race?", isAkshayFaster);
...
console.log("Did Akshay Akshy jump than Ravi?", isAkshayHigherJump);
...
console.log(
  "Can I buy both Milk and Bread within my budget?",
  areBothUnderBudget
);
...
let averageScore =
  (gangaCricketClubScore +
    yamunaCricketClubScore +
    narmadaCricketClubScore +
    godavariCricketClubScore) /
  4;
...
console.log("2.3");
let numberOfStudent = 72;

let isDivisibleBy4 = numberOfStudent % 4 === 0;

let isDivisibleBy9 = numberOfStudent % 9 === 0;
